...
import pathlib, os
import math
from FinishedResourceList import *
...
def open_list():
        exec(open("FinishedResourceList.py").read())
...
class TextFrame():
    def __init__(self, the_window):
        ...
        canvas2.pack()
        button = Button(canvas2, text = "Resources", bg = "gray", height = 5, width = 10, command = open_list)
        button.pack()
