...
def createSourcesWindow():
    ...
    root.configure(bg="#CDC0B0") #changing root window background (tanish color)

    # position the button
    COLONE = 50
    COLTWO = 160
    button1.place(x = COLONE, y = 30)
    button2.place(x = COLONE, y = 70)
    button3.place(x = COLONE, y = 110)
    button4.place(x = COLONE, y = 150)
    button5.place(x = COLONE, y = 190)
    button6.place(x = COLTWO, y = 30)
    button7.place(x = COLTWO, y = 70)
    button8.place(x = COLTWO, y = 110)
    button9.place(x = COLTWO, y = 150)
    button10.place(x = COLTWO, y = 190)
    button11.place(x = 120, y = 230)
